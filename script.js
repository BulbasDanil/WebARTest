console.log("is this scrpit running?")
...
init();
console.log("Init finished working")
animate();
console.log("Animate finished working")
...
function render(timestamp, frame) {
  ...
  if (frame) {
    console.log("Render function received a frame")
    ...
    for (const result of results) {
      ...
      console.log("Render function received the result")
